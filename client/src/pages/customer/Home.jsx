    ...
    <div className='font-sans text-gray-800'>
      ...
      <section className='py-24 bg-neutral-900 text-white text-center px-4 relative overflow-hidden'>
        ...
        <div className='relative z-10 max-w-3xl mx-auto'>
            ...
            <p className='text-gray-400 mb-10 text-lg'>Sign up for exclusive offers, early access to new collections, and style tips directly to your inbox.</p>
            <div className='flex flex-col sm:flex-row justify-center gap-4 max-w-lg mx-auto'>
                <input type="email" placeholder="Your email address" className='px-6 py-4 rounded-full text-gray-900 focus:outline-none focus:ring-2 focus:ring-yellow-400 w-full' />
                <button className='bg-yellow-400 text-black font-bold px-8 py-4 rounded-full hover:bg-yellow-500 transition duration-300 whitespace-nowrap shadow-lg hover:shadow-yellow-400/50'>Subscribe</button>
            </div>
        </div>
      </section>
